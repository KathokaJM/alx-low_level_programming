...
/**
 * check_elf - to check if file is ELF
 * @e_ident: pointer to array with ELF magic numbers
 *
 * Description: If the file not an ELF file then, - exit code 98.
 */
void check_elf(unsigned char *e_ident)
{
	int index;
...
/**
 * print_magic - printing magic numbers of ELF header
 * @e_ident: Pointer to array with ELF magic numbers
 *
...
/**
 * print_class - Printing class of ELF header
...
/**
 * print_version - Printing ELF header version
 ...
 * @e_ident:pPointer to array with the ELF ABI version
 */
void print_abi(unsigned char *e_ident)
{
...
/**
 * main - display information with the
 * ELF header at begining of ELF file
 * @argc: Number of arguments directed to program
